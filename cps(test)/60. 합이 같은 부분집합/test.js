  ...
  for (let i = 0; i < 5 * 2; ++i) {
    if (i % 2 === 0) {
      ...
      if (str1.localeCompare(str2) === 0) {
        console.log(FgBlue, "OK ", Math.floor(i / 2 + 1), "/ 5", Reset);
        ++check;
      } else console.log(FgRed, "KO", Reset);
    }
  }

  if (check === 5) console.log(FgBlue, "[All OK]", Reset);
  else console.log(FgRed, "[Wrong]", check, "/ 5", Reset);
})();
